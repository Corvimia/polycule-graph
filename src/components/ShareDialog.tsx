        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-md w-full bg-white dark:bg-neutral-900 rounded-lg shadow-2xl z-50 p-6">
          ...
          <div className="space-y-4">
            <div className="text-sm text-gray-600 dark:text-gray-300">
              ...
              <p className="mt-2">
                ⚠️ Important: This link will <strong>not</strong> update automatically when you make
                changes.
              </p>
              <p className="mt-2 text-sm">
                After adding favorites, renaming nodes, or making any changes, you'll need to click
                Share again to get an updated link.
              </p>
            </div>
