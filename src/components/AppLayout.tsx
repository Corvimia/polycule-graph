...
interface AppLayoutProps {
  sidebar: (layout: { sidebarOpen: boolean; setSidebarOpen: (open: boolean) => void; isMobile: boolean; }) => ReactNode;
  main: (layout: { sidebarOpen: boolean; setSidebarOpen: (open: boolean) => void; isMobile: boolean; }) => ReactNode;
}
